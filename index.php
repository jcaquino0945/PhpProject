...
<body>
    ...
    <nav class="navbar shadow">
        ...
        <div class="navbar-links">
            <a href="#">Title calculator</a>
            <a href="#" style="color:red">Employees</a>
        </div> 
    </nav>
    ...
    <form action="welcome_get.php" method="get">
        ...
        <div class="form-row">
            <div class="form-row-child">
                <label for="inputPlaceholder3">Placeholder</label>
        ...
        <div class="form-row">
            <div class="form-row-child">
                ...
                <input type="Placeholder" class="form-control" id="inputPlaceholder3" placeholder="Placeholder" name="val3">
            </div>
            
            <div class="form-row-child">
                <label for="inputPlaceholder3">Absences</label>
                <input type="Placeholder" class="form-control" id="inputPlaceholder3" placeholder="Placeholder" name="val4">
            </div>
        </div>
